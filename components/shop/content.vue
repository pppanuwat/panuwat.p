          ...
          >
            ...
            <div class="bg-white p-6 rounded-lg shadow-2xl">
              <div class="mb-2">
                <img
                  class="rounded-lg"
                  src="https://img.freepik.com/free-photo/fresh-coffee-steams-wooden-table-close-up-generative-ai_188544-8923.jpg?size=626&ext=jpg&ga=GA1.1.1700460183.1708300800&semt=sph"
                />
                <h1 class="text-xl font-bold text-slate-900">cappuccino</h1>
              </div>
              <div
                class="text-sm leading-relaxed text-slate-500 space-y-4 mb-2"
              >
                <p>test</p>
              </div>
